...
<body>
	...
	<div class="container-fluid margintop">
		<ol class="breadcrumb">
			...
			<li><a href="<?php echo base_url('admin/manage-doctor'); ?>">Manage Doctor</a></li>
	...
	<div class="container">
		<div class="row">
			...
			<?php
				...
				echo form_open('admin/doctor/add-category', $attrib);
			?>
				<div class="panel panel-primary">
					...
					<div class="panel-body">
						<div class="form-group">
							...
							<div class="col-sm-10">
								<input type="text" name="dct_cat" class="form-control" id="catName" autofocus placeholder="Category Name">
							</div>
						</div>
					</div>
					<div class="panel-footer text-right">
						<button class="btn btn-success" name="save" value="save"><i class="fa fa-paper-plane fa-fw"></i> Submit</button>
					</div>
				</div>
			<?php echo form_close(); ?>
		</div>
