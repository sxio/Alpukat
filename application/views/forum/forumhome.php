					...
					<table class="table forum table-striped">
						...
						<tbody>
							...
							<tr>
								...
								<td class="hidden-xs hidden-sm">by <a href="<?php echo base_url('forum/detail/'.$ht['FORUM_ID']. '#'. $ht['FORUM_LAST_POST']); ?>"><?php echo $ht['LAST_ID']; ?></a><br><small><i class="fa fa-clock-o"></i> <?php echo timespan(mysql_to_unix($ht['USER_DT']), now(), 1) . ' ago'; ?></small></td>
							</tr>
							<?php endforeach; ?>
						</tbody>
					</table>
